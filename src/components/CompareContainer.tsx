...
import { pokemonStatType, pokemonTypesInterface, userPokemonsTypes } from '../utils/Types'
...
const CompareContainer = ({
    ...
    const createStatsArray = (types: pokemonTypesInterface[], statType: pokemonStatType) => {
        ...
        <div className='compare-container'>
            {
                isEmpty && (
                    <div className="empty">
                        ...
                        <h3>Add some pokemon to comparisson</h3>
                    </div>
                )
            }
            {
